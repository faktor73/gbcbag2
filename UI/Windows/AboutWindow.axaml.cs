...
namespace Mesen.Windows
{
	public class AboutWindow : MesenWindow
	{
		...
		public AboutWindow()
		{
			...
			this.GetControl<TextBlock>("lblCopyright").Text = $"Mesen Copyright 2014-{DateTime.Now.Year} Sour";
		}
		...
		private void OnNesbagLinkTapped(object? sender, TappedEventArgs e)
		{
			ApplicationHelper.OpenBrowser("https://www.eastpixel.de/gbcbag");
		}
	}
