			...
			new MainMenuAction() {
				...
				new MainMenuAction() {
					...
					SubActions = new List<object>() {
						...
						new ContextMenuSeparator(),
						(ConfigManager.Config.EnableVFilter_BRZ ? GetVideoFilterMenuItem(VideoFilterType.xBRZ2x) : null),
						(ConfigManager.Config.EnableVFilter_BRZ ? GetVideoFilterMenuItem(VideoFilterType.xBRZ3x) : null),
						(ConfigManager.Config.EnableVFilter_BRZ ? GetVideoFilterMenuItem(VideoFilterType.xBRZ4x) : null),
						(ConfigManager.Config.EnableVFilter_BRZ ? GetVideoFilterMenuItem(VideoFilterType.xBRZ5x) : null),
						(ConfigManager.Config.EnableVFilter_BRZ ? GetVideoFilterMenuItem(VideoFilterType.xBRZ6x) : null),
						(ConfigManager.Config.EnableVFilter_BRZ ? new ContextMenuSeparator() : null),
						(ConfigManager.Config.EnableVFilter_HQ ? GetVideoFilterMenuItem(VideoFilterType.HQ2x) : null),
						(ConfigManager.Config.EnableVFilter_HQ ? GetVideoFilterMenuItem(VideoFilterType.HQ3x) : null),
						(ConfigManager.Config.EnableVFilter_HQ ? GetVideoFilterMenuItem(VideoFilterType.HQ4x) : null),
						(ConfigManager.Config.EnableVFilter_HQ ? new ContextMenuSeparator() : null),
						(ConfigManager.Config.EnableVFilter_Scale ? GetVideoFilterMenuItem(VideoFilterType.Scale2x) : null),
						(ConfigManager.Config.EnableVFilter_Scale ? GetVideoFilterMenuItem(VideoFilterType.Scale3x) : null),
						(ConfigManager.Config.EnableVFilter_Scale ? GetVideoFilterMenuItem(VideoFilterType.Scale4x) : null),
						(ConfigManager.Config.EnableVFilter_Scale ? new ContextMenuSeparator() : null),
						(ConfigManager.Config.EnableVFilter_Sai ? GetVideoFilterMenuItem(VideoFilterType._2xSai) : null),
						(ConfigManager.Config.EnableVFilter_Sai ? GetVideoFilterMenuItem(VideoFilterType.Super2xSai) : null),
						(ConfigManager.Config.EnableVFilter_Sai ? GetVideoFilterMenuItem(VideoFilterType.SuperEagle) : null),
						(ConfigManager.Config.EnableVFilter_Sai ? new ContextMenuSeparator() : null),
						(ConfigManager.Config.EnableVFilter_Prescale ? GetVideoFilterMenuItem(VideoFilterType.Prescale2x) : null),
						(ConfigManager.Config.EnableVFilter_Prescale ? GetVideoFilterMenuItem(VideoFilterType.Prescale3x) : null),
						(ConfigManager.Config.EnableVFilter_Prescale ? GetVideoFilterMenuItem(VideoFilterType.Prescale4x) : null),
						(ConfigManager.Config.EnableVFilter_Prescale ? GetVideoFilterMenuItem(VideoFilterType.Prescale6x) : null),
						(ConfigManager.Config.EnableVFilter_Prescale ? GetVideoFilterMenuItem(VideoFilterType.Prescale8x) : null),
						(ConfigManager.Config.EnableVFilter_Prescale ? GetVideoFilterMenuItem(VideoFilterType.Prescale10x) : null),
						(ConfigManager.Config.EnableVFilter_Prescale ? new ContextMenuSeparator() : null),
						new MainMenuAction() {
